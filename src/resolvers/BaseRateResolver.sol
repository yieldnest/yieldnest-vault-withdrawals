...
abstract contract BaseRateResolver is BaseResolver {
    ...
    function resolutionFee(uint256 id, address asset, uint256 assets) public view override returns (uint256 fee) {
